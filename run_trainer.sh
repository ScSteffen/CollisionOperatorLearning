...
### 3) Toy 3D isotropic
## vanila DeepONet wo/ bias
python3 train.py 3_16_3_16_wo_bias --seed 0 --gpu 0 --data_file toy  --dimension 3 --integration_order 10 --model deeponet --branch_hidden 200 16 16 16 --trunk_hidden 3 16 16 16 --use_bias no --epochs 100000 --lambda 0

## vanila DeepONet w/ bias
python3 train.py 3_16_3_16_w_bias --seed 0 --gpu 0 --data_file toy --dimension 3 --integration_order 10 --model deeponet --branch_hidden 200 16 16 16 --trunk_hidden 3 16 16 16 --use_bias vanila --epochs 100000 --lambda 0

## (soft constraint) DeepONet with additional orthogonal loss
python3 train.py 3_16_3_16_soft_lamb01 --seed 0 --gpu 0 --data_file toy --dimension 3 --integration_order 10 --model deeponet --branch_hidden 200 16 16 16 --trunk_hidden 3 16 16 16 --use_bias vanila_ortho --epochs 100000 --lambda 0.1

## (Hard constraint) DeepONet with gram schmidt for basis
python3 train.py 3_16_3_16_hard_gram --seed 0 --data_file toy --dimension 3 --integration_order 10 --model deeponet --branch_hidden 200 16 16 16 --trunk_hidden 3 16 16 16 --use_bias gram --use_gram --epochs 100000 --lambda 0

## (Hard constraint) DeepONet with special bias
python3 train.py 3_16_3_16_hard_special --seed 0 --gpu 0 --data_file toy --dimension 3 --integration_order 10 --model deeponet --branch_hidden 200 16 16 16 --trunk_hidden 3 16 16 16 --use_bias depend --epochs 100000 --lambda 0
...
## vanila DeepONet wo/ bias
python3 train.py 3_64_3_64_wo_bias --seed 0 --gpu 0 --data_file entropy --dimension 1 --integration_order 100 --model deeponet --branch_hidden 100 64 64 64 --trunk_hidden 1 64 64 64 --use_bias no --epochs 10000 --lambda 0

## vanila DeepONet w/ bias
python3 train.py 3_64_3_64_w_bias --seed 0 --gpu 0 --data_file entropy --dimension 1 --integration_order 100 --model deeponet --branch_hidden 100 64 64 64 --trunk_hidden 1 64 64 64 --use_bias vanila --epochs 10000 --lambda 0

## (soft constraint) DeepONet with additional orthogonal loss
python3 train.py 3_64_3_64_soft_lamb01 --seed 0 --gpu 0 --data_file entropy --dimension 1 --integration_order 100 --model deeponet --branch_hidden 100 64 64 64 --trunk_hidden 1 64 64 64 --use_bias vanila_ortho --epochs 10000 --lambda 0.1

## (Hard constraint) DeepONet with gram schmidt for basis
python3 train.py 3_64_3_64_hard_gram --seed 0 --gpu 0 --data_file entropy --dimension 1 --integration_order 100 --model deeponet --branch_hidden 100 64 64 64 --trunk_hidden 1 64 64 64 --use_bias gram --use_gram --epochs 10000 --lambda 0

## (Hard constraint) DeepONet with special bias
python3 train.py 3_64_3_64_hard_special --seed 0 --gpu 0 --data_file entropy --dimension 1 --integration_order 100 --model deeponet --branch_hidden 100 64 64 64 --trunk_hidden 1 64 64 64 --use_bias depend --epochs 10000 --lambda 0
