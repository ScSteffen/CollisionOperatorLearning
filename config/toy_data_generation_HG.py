# python3 toy_data_generation_HG.py train_300_test_300 --seed 0 --dimension 1 --integration_order 100 --aniso_param 0.9 --num_train 100 --num_test 100
# python3 toy_data_generation_HG.py train_300_test_300 --seed 0 --dimension 3 --integration_order 10 --aniso_param 0.9 --num_train 100 --num_test 100
...
np.savez(os.path.join(PATH, 'toy_HG_train_data.npz'),data_f=np.array(data_f), data_Q=np.array(data_Q))
...
np.savez(os.path.join(PATH, 'toy_HG_test_data.npz'),data_f=np.array(data_f), data_Q=np.array(data_Q))