...
np.savez(os.path.join(PATH, 'train_data.npz'),data_f=np.array(data_f), data_Q=np.array(data_Q))
...
np.savez(os.path.join(PATH, 'test_data.npz'),data_f=np.array(data_f), data_Q=np.array(data_Q))